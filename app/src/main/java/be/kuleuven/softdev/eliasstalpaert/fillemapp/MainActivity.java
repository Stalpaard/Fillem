...
public class MainActivity extends AppCompatActivity {
    ...
    private void initColours(){
        rangeBarYear.setConnectingLineColor(getIntFromColor(128,128,128));
        rangeBarYear.setBarColor(getIntFromColor(0,0,0));
        rangeBarYear.setThumbColorNormal(getIntFromColor(192,192,192));
        rangeBarYear.setThumbColorPressed(getIntFromColor(169,169,169));
    }
